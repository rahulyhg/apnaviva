<?php include "includes/header.php" ?>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <?php
         ...
         $questions_count="SELECT * from posts4 where post_question LIKE '%$search%'";
         ...
         $select_question="SELECT * from posts4 where post_question LIKE '%$search%' LIMIT $start_count,$per_page";
  ...
  for($i=1;$i<=$count;$i++){
       ...
       if($page>$count){
         ...
         echo "<li class='page-item active'><a class='page-link' href='search4.php?page=$i'>$i</a></li>";
       }
       else{
         echo "<li class='page-item'><a class='page-link' href='search4.php?page=$i'>$i</a></li>";
       }
...
<br><br>
     <?php
       ...
       if(isset($_POST['submit'])){
           ...
           header('Location:search4.php?page=1');
