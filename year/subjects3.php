        ...
        <?php
         ...
         if(isset($_GET['page'])){
          ...
          header("Location:pagenotfound.php");
           ...
           header("Location:subjects3.php?s_id=$s_id&page=1");
         }
         ...
         $questions_count="SELECT * from posts3 WHERE post_subject_id='$s_id' ";
         ...
         $select_question="SELECT * from posts3 WHERE post_subject_id='$s_id' LIMIT $start_count,$per_page ";
...
<span class="text-primary">
           <?php echo ucwords($author_name); ?></span>
          </p>
       ...
       for($i=1;$i<=$count;$i++){
         ...
         if($page>$count){
          header("Location:pagenotfound.php");
            ...
            echo "<li class='page-item active'><a class='page-link' href='subjects3.php?s_id=$s_id&page=$i'>$i</a></li>";
         }else{
            echo "<li class='page-item'><a class='page-link' href='subjects3.php?s_id=$s_id&page=$i'>$i</a></li>";
         }
 ...
 <br><br>
     <?php
       ...
       if(isset($_POST['submit'])){
           ...
           $insert_post="INSERT INTO `posts3` (`post_id`, `post_question`, `post_answer`, `post_date`,
                         `post_author_name`,`post_subject_id`) VALUES('','$ques','$ans',now(),'$name','$pid')";
           $insert_query=mysqli_query($connection,$insert_post);
           if(!$insert_query){
             die("Connection failed ".mysqli_error($connection));
           }
           header("Location:subjects3.php?s_id=$pid");
     ...
     -->
               <!-- Subjects Widget -->
          <?php include "includes/subjects_widget3.php" ?>
          <!-- Side Widget -->
          <div class="card my-4">
