        ...
        <?php
         ...
         if(isset($_GET['page'])){
          ...
          header("Location:pagenotfound.php");
           ...
           header("Location:subjects2.php?s_id=$s_id&page=1");
         }
         ...
         $questions_count="SELECT * from posts2 WHERE post_subject_id='$s_id' ";
         ...
         $select_question="SELECT * from posts2 WHERE post_subject_id='$s_id' LIMIT $start_count,$per_page ";
       ...
       for($i=1;$i<=$count;$i++){
         ...
         if($page>$count){
          header("Location:pagenotfound.php");
            ...
            echo "<li class='page-item active'><a class='page-link' href='subjects2.php?s_id=$s_id&page=$i'>$i</a></li>";
         }else{
            echo "<li class='page-item'><a class='page-link' href='subjects2.php?s_id=$s_id&page=$i'>$i</a></li>";
         }
 ...
 <br><br>
     <?php
       ...
       if(isset($_POST['submit'])){
           ...
           header("Location:subjects2.php?s_id=$pid");
