    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <?php
         ...
         $questions_count="SELECT * from posts where post_question LIKE '%$search%'";
         ...
         $select_question="SELECT * from posts where post_question LIKE '%$search%' LIMIT $start_count,$per_page";
