<?php include "includes/header.php" ?>
        ...
        <?php
         ...
         if(isset($_GET['page'])){
          ...
          header("Location:pagenotfound.php");
           ...
           header("Location:search2.php?page=1");
         }
         ...
         $questions_count="SELECT * from posts2 where post_question LIKE '%$search%'";
         ...
         $select_question="SELECT * from posts2 where post_question LIKE '%$search%' LIMIT $start_count,$per_page";
  ...
  for($i=1;$i<=$count;$i++){
       ...
       if($page>$count){
         ...
         echo "<li class='page-item active'><a class='page-link' href='search2.php?page=$i'>$i</a></li>";
       }
       else{
         echo "<li class='page-item'><a class='page-link' href='search2.php?page=$i'>$i</a></li>";
       }
