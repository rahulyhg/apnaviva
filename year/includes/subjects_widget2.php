<div class="card my-4">
    <h4 class="card-header">Question Search (Year 2)</h4>
    <form action="search2.php?page=1" method="post">
...
<div class="card my-4">
  <h5 class="card-header">Subject Wise Questions (Year 2)</h5>
  <div class="card-body">
    <div class="row">
      <div class="col-lg-12">
        <ul class="list-unstyled text-center mb-0">
            ...
            <?php
               ...
               while ( $row=mysqli_fetch_assoc($query)) {
                 ...
                 $sub_id=$row['sub_id'];
             ?>
          <li class="p-2">  <a class="btn btn-primary" style="width:250px" href="subjects2.php?s_id=<?php echo $sub_id; ?>"><?php echo ucwords($sub_title); ?></a></li>
<?php } ?>
        <hr>
        <li><a href="year2.php" class="btn btn-dark">All Subject Questions</a></li>
        </ul>
      </div>
