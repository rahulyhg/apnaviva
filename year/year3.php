        ...
        <?php
         ...
         if(isset($_GET['page'])){
          ...
          header("Location:pagenotfound.php");
           ...
           header("Location:year3.php?page=1");
         }
         ...
         $questions_count="SELECT * from posts3";
         ...
         $select_question="SELECT * from posts3 LIMIT $start_count,$per_page";
         ...
         ?>
          ...
          <p class="lead">
              by
            <span class="text-primary"><?php echo ucwords($author_name); ?></a>
          </p>
  ...
  for($i=1;$i<=$count;$i++){
       ...
       if($page>$count){
        header("Location:pagenotfound.php");
         ...
         echo "<li class='page-item active'><a class='page-link' href='year3.php?page=$i'>$i</a></li>";
       }
       else{
         echo "<li class='page-item'><a class='page-link' href='year3.php?page=$i'>$i</a></li>";
       }
