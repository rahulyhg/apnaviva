        ...
        <li class="dropdown pl-2 pt-2">
          ...
          <div class="dropdown-menu">
            ...
            while($row=mysqli_fetch_assoc($query)){
              ...
              $sub_id=$row['sub_id'];
            ?>
            <a class="dropdown-item" href="subjects4.php?s_id=<?php echo $sub_id; ?>"><?php echo $sub_title; ?></a>
          <?php } ?>
           <hr>
